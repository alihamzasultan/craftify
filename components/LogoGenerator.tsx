...
const ImageGenerator: React.FC = () => {
  ...
  const [images, setImages] = useState<string[]>([]); // Fixed `any[]` to `string[]`

  useEffect(() => {
    if (!username) return; // Avoid API call if username is undefined
    ...
    fetchImages();
  }, [username, imageData]); // Added `username` to dependency array
    ...
    <div>
      <div
        style={{
          ...
          margin: "auto", // Fixed margin issue
        }}
      >
